...
def main():
    ...
    X_Train = np.genfromtxt('/home/zhengxi/code/MRCs-for-Covariate-Shift-Adaptation-main/Datasets_20News'
                            '/comp_vs_sci_X_Train.csv', delimiter=',')
    Y_Train = np.genfromtxt('/home/zhengxi/code/MRCs-for-Covariate-Shift-Adaptation-main/Datasets_20News'
                            '/comp_vs_sci_Y_Train.csv', delimiter=',')
    X_Test = np.genfromtxt('/home/zhengxi/code/MRCs-for-Covariate-Shift-Adaptation-main/Datasets_20News'
                           '/comp_vs_sci_X_Test.csv', delimiter=',')
    Y_Test = np.genfromtxt('/home/zhengxi/code/MRCs-for-Covariate-Shift-Adaptation-main/Datasets_20News'
                           '/comp_vs_sci_Y_Test.csv', delimiter=',')
